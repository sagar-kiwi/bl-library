...
- (void)openInInAppBrowser:(NSURL*)url withOptions:(NSString*)options
{
    ...
    // changing Done button color to red
    self.inAppBrowserViewController.closeButton.tintColor = [UIColor colorWithRed:192.0 / 255.0 green:0.0 / 255.0 blue:0.0 / 255.0 alpha:1];
